...
// const rpcClient = "https://lb-fullnode.chameleon.org/fullnode";
//  new RpcClient("https://mainnet.chameleon.org/fullnode");
// const rpcClient = "https://testnet.chameleon.org/fullnode";
const rpcClient = "http://localhost:9334";
// const rpcClient = new RpcClient("https://dev-test-node.chameleon.org");
// const rpcClient = new RpcClient("http://54.39.158.106:9334");
// const rpcClient = new RpcClient("http://139.162.55.124:8334");   // dev-net
// const rpcClient = "https://testnet1.chameleon.org/fullnode"; //testnet1
// "http://139.162.55.124:8334";

const stagingServices = "https://api-coinservice-staging.chameleon.org";

const rpcCoinService =
  // "https://api-coinservice.chameleon.org"; //mainnet
  stagingServices; //testnet
// "https://api-coinservice-staging2.chameleon.org"; // testnet1
// "http://51.161.119.66:9009"; //dev-test-coin-service
const rpcTxService = `${stagingServices}/txservice`;
//  "https://api-coinservice.chameleon.org/txservice"; mainnet
// "https://api-coinservice-staging.chameleon.org/txservice";
//  "https://api-coinservice-staging2.chameleon.org/txservice"; // testnet1
//  "http://51.161.119.66:8001"; //dev-test-coin-service
const rpcRequestService = `${stagingServices}/airdrop-service`;
// "https://api-coinservice.chameleon.org/airdrop-service"; // mainnet
...
const rpcApiService =
  //  "https://api-service.chameleon.org"; // mainnet
  "https://staging-api-service.chameleon.org"; // testnet
//  "https://privacyv2-api-service.chameleon.org";
