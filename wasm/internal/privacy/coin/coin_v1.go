...
import (
	...
	henc "chameleon-chain/privacy/privacy_v1/hybridencryption"
)
...
func (c CoinV1) Decrypt(keySet *chameleonkey.KeySet) (PlainCoin, error) {
	if keySet == nil {
...
// func (c *CoinV1) DoesCoinBelongToKeySet(keySet *chameleonkey.KeySet) (bool, *operation.Point) {
