...
// 	hmacObj := hmac.New(sha512.New, []byte("chameleon Seed"))
...
// 	keySet := (&chameleonkey.KeySet{}).GenerateKey(keyBytes)
...
// 	newKeyset := (&chameleonkey.KeySet{}).GenerateKey(newSeed)
...
// in the standard chameleon base58 encoding
